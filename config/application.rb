...
module FatFreeCrm
  class Application < Rails::Application
    ...
    config.autoload_paths += Dir[Rails.root.join('app/models/fat_free_crm/**')] +
    ...
    config.autoload_once_paths += [File.expand_path('../app/models/fat_free_crm/fields/field.rb', __FILE__)]
