...
#  skype           :string(128)
#
#module FatFreeCrm::Entities
module FatFreeCrm
  class Entities::Lead < ActiveRecord::Base
    belongs_to :user
    belongs_to :campaign
    ...
    validates_presence_of :first_name, :message => :missing_first_name if FatFreeCrm::Setting.require_first_names
